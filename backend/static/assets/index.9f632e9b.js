var e = Object.defineProperty
  ...
  , n = (e,a)=>{
    for (var s in a || (a = {}))
        o.call(a, s) && r(e, s, a[s]);
    if (t)
        for (var s of t(a))
            c.call(a, s) && r(e, s, a[s]);
    return e
}
  , i = (e,t)=>a(e, s(t));
import {o as l, c as d, r as p, a as m, b as u, p as k, d as f, F as y, k as v, u as w, e as g, f as b, g as h, t as x, h as C, w as j, i as S, _ as P, j as _, l as K, m as A, n as W, q as I, s as L, v as O, x as V} from "./vendor.e0b00493.js";
!function() {
    ...
    function a(e) {
        ...
        const a = function(e) {
            ...
            "use-credentials" === e.crossorigin ? a.credentials = "include" : "anonymous" === e.crossorigin ? a.credentials = "omit" : a.credentials = "same-origin",
            a
        }(e);
        fetch(e.href, a)
    }
        ...
        const s = async()=>{
            try {
                ...
                if (e) {
                    ...
                    if (!s)
                        return P.error("获取用户CK信息失败，请重重新登录"),
                        void t();
                    a.nickName = s.data.nickName,
                    a.timestamp = new Date(s.data.timestamp).toLocaleString()
                }
                if (s) {
                    const e = await getWSCKUserinfoAPI(s);
                    if (!e)
                        return P.error("获取用户WSCK信息失败，请重重新登录"),
                        void t();
                    a.nickName = e.data.nickName,
                    a.timestamp = new Date(e.data.timestamp).toLocaleString()
                }
            } catch (e) {
                console.error(e)
            }
        ...
        return i(n({}, x(a)), {
            ...
            delAccount: async()=>{
                try {
                    const e = localStorage.getItem("eid")
                      , a = await function(e) {
                        return $.post("delaccount", {
                            json: e
                        }).json()
                    }({
                        eid: e
                    });
                    200 !== a.code ? P.error(a.message) : (P.success(a.message),
                    setTimeout((()=>{
                        t()
                    }
                    ), 1e3))
            ...
            changeremark: async()=>{
                try {
                    const s = localStorage.getItem("eid")
                      , t = localStorage.getItem("wseid")
                      , o = a.remark;
                    if (s) {
                        const e = await function(e) {
                            return $.post("update/remark", {
                                json: e
                            }).json()
                        }({
                            eid: s,
            ...
            WSCKLogin: async()=>{
                try {
                    ...
                    if (e && s) {
                        ...
                        a.data.wseid ? (localStorage.setItem("wseid", a.data.wseid),
                        P.success(a.message)) : P.error(a.message || "wskey 解析失败，请检查后重试！")
                    } else
                        P.error("wskey 解析失败，请检查后重试！")
                } catch (e) {
                    console.error(e)
                }
            }
            ...
            delWSCKAccount: async()=>{
                try {
                    const e = localStorage.getItem("wseid")
                      , a = await function(e) {
                        return $.post("WSCKDelaccount", {
                            json: e
                        }).json()
                    }({
                        wseid: e
            ...
            openUrlWithJD: e=>{
                ...
                window.location.href = `openapp.jdmobile://virtual?params=${a}`,
                console.log(window.location.href)
            }
        })
    }
}
  , G = e=>(k("data-v-67328e70"),
e = e(),
f(),
e)
  , H = {
...
var we = N(B, [["render", function(e, a, s, t, o, c) {
    const r = p("el-button")
      , n = p("el-input");
    return l(),
    d("div", H, [m("div", F, [M, m("div", X, [m("p", null, "昵称：" + C(e.nickName), 1), m("p", null, "更新时间：" + C(e.timestamp), 1)]), m("div", Y, [u(r, {
        size: "small",
        auto: "",
        onClick: t.logout
    }, {
        ...
        default: j((()=>[me])),
        _: 1
    }, 8, ["onClick"])])]), m("div", ue, [ke, m("div", fe, [m("ul", null, [(l(!0),
    d(y, null, S(t.activity, ((e,a)=>(l(),
    d("li", {
        key: a,
        class: "leading-normal"
    }, [m("span", null, C(e.name) + "：", 1), m("span", ye, C(e.address), 1), e.href ? (l(),
    d("a", {
        key: 0,
        class: "text-blue-400",
        href: "#",
    ...
    setup() {
        ...
        const s = async()=>{
            try {
                ...
                a.marginCount = e.marginCount,
                a.allowAdd = e.allowAdd,
                a.marginWSCKCount = e.marginWSCKCount,
                a.allowWSCKAdd = e.allowWSCKAdd,
                a.showQR = e.showQR,
                a.showWSCK = e.showWSCK,
                a.showCK = e.showCK
            } catch (e) {
                console.error(e)
            }
            ...
            , t = async () => {
                if (this.showQR != undefined && this.showQR)
                try {
                    const e = await $.get("qrcode").json();
                    a.token = e.data.token,
                    a.okl_token = e.data.okl_token,
                    a.cookies = e.data.cookies,
                    a.QRCode = e.data.QRCode,
                    a.QRCode && (a.waitLogin = !0,
                    clearInterval(a.timer),
                    a.timer = setInterval(o, 3e3))
                } catch (e) {
                    console.error(e),
                    P.error("生成二维码失败！请重试或放弃")
                }
            else
                P.warning("扫码已禁用请手动抓包")
        }
          , o = async()=>{
            try {
                const s = await function(e) {
                    ...
                    token: a.token,
                    okl_token: a.okl_token,
                    cookies: a.cookies
                });
                switch (null == s ? void 0 : s.data.errcode) {
                case 0:
                    localStorage.setItem("eid", s.data.eid),
                    P.success(s.message),
                    clearInterval(a.timer),
                    e.push("/");
                    break;
            ...
            CKLogin: async()=>{
                try {
                    ...
                    if (s && t) {
                        ...
                        a.data.eid ? (localStorage.setItem("eid", a.data.eid),
                        P.success(a.message),
                        e.push("/")) : P.error(a.message || "cookie 解析失败，请检查后重试！")
                    } else
                        P.error("cookie 解析失败，请检查后重试！")
                } catch (s) {
                    console.error(s)
                }
            }
            ...
            WSCKLogin: async()=>{
                try {
                    ...
                    if (s && t) {
                        ...
                        a.data.wseid ? (localStorage.setItem("wseid", a.data.wseid),
                        P.success(a.message),
                        e.push("/")) : P.error(a.message || "wskey 解析失败，请检查后重试！")
                    } else
                        P.error("wskey 解析失败，请检查后重试！")
                } catch (s) {
                    console.error(s)
...
const ea = [{
    ...
    path: "/login",
    component: N(ge, [["render", function(e, a, s, t, o, c) {
        const r = p("el-button")
          , n = p("el-input");
        return l(),
        d("div", he, [xe, e.showQR ? (l(),
        d("div", Ce, [m("div", je, [m("div", Se, [Pe, m("span", _e, "余量：" + C(e.marginCount), 1)]), Ke]), m("div", Ae, [e.qrCodeVisibility ? (l(),
        d("img", {
            key: 1,
            src: e.QRCode,
            width: 256,
        ...
        d("div", We, [u(r, {
            ...
            default: j((()=>[Le])),
            _: 1
        }, 8, ["onClick"])]))]), Ve])) : K("", !0), e.showWSCK ? (l(),
        d("div", Ne, [m("div", Qe, [m("div", Ue, [De, m("span", Re, "余量：" + C(e.marginWSCKCount), 1)]), ze]), m("div", qe, [u(n, {
            modelValue: e.jdwsck,
            "onUpdate:modelValue": a[0] || (a[0] = a=>e.jdwsck = a),
            placeholder: "pin=xxxxxx;wskey=xxxxxxxxxx;",
            size: "small",
            ...
            default: j((()=>[Te])),
            _: 1
        }, 8, ["onClick"])]), Ee])) : K("", !0), e.showCK ? (l(),
        d("div", Je, [m("div", $e, [m("div", Ze, [Be, m("span", Ge, "余量：" + C(e.marginCount), 1)]), He, Fe]), m("div", Me, [u(n, {
            modelValue: e.cookie,
